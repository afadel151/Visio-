...
async function clickHandlerForRooms(event) {
    ...
    await GetAvailableRooms(Target, session_datee, timing_idd);
}
...
async function NewInnerCour(tr, session, moduleOptions, teacherOptions, roomOptions) {
    tr.innerHTML = 
        `
...
async function PostCour(data, teachers, modules, rooms, tr) {
    try {
        ...
        const moduleOptions = modules
            ...
            .join("");
        NewInnerCour(tr,session,moduleOptions,teacherOptions,roomOptions);
    } catch (error) {
        console.log(error);
    }
}
async function clickHandler(event) {
    ...
    await PostCour(data, teachers, modules, rooms, tr);
}
    ...
    await axios
        ...
        .then(function (response) {
            ...
            const moduleOptions = modules
                ...
                .join("");
         NewInnerTd(tr,td,session,moduleOptions,teacherOptions,roomOptions);
