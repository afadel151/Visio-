    ...
    <div class="container flex justify-center items-center flex-col w-[100%]  mt-20">
        ...
        <div class="card p-4 mt-20 w-[90%] mb-20">
            ...
            <div class="card-body w-[100%]">
                {{-- {!! $dataTab->table() !!} --}}
                <table class="table table-bordered w-[100%] display" id="modules">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Module</th>
        ...
        <div class=" h-44 border-2 rounded-2xl flex justify-center items-center mb-20">
            ...
            <dialog id="my_modal_4" class="modal">
                <div class="modal-box font-bold w-3/12 h-[50%] max-w-5xl flex flex-col justify-between">
                    <div>
                        <h3 class="font-bold text-2xl">Add a module!</h3>
                    </div>
                    <form id="create-teacher" action="{{route('modules.create')}}" method="POST" enctype="multipart/form-data"  class="flex text-lg flex-col justify-around items-center space-y-4 ">
                        @csrf
