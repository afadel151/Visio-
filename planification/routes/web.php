...
Route::middleware('auth')->group(function () {
    Route::prefix('/')->group(function () {
        ...
        Route::prefix('holidays')->group(function () {
            ...
            Route::post('/destroy', [HolidayController::class, 'destroy'])->name('holidays.destroy');
        });
        Route::prefix('occasions')->group(function () {
            Route::get('/', [OccasionController::class, 'index'])->name('occasions.index');
            Route::post('/store', [OccasionController::class, 'store'])->name('occasions.store');
            Route::post('/destroy', [OccasionController::class, 'destroy'])->name('occasions.destroy');
        });
        ...
        Route::prefix('schoolyears')->group(function () {
            ...
            Route::get('/current', [SchoolYearController::class, 'show_current'])->name('schoolyears.show_current');  
            Route::get('/{id}', [SchoolYearController::class, 'show'])->name('schoolyears.show');
            Route::get('/{id}/modules', [SchoolYearController::class, 'modules'])->name('schoolyears.schoolyear_modules');
        ...
        Route::prefix('settings')->group(function () {
            ...
            Route::post('/config/update', [SettingsController::class, 'update_config'])->name('configs.update');
        });
